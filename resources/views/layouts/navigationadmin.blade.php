    ...
    <div id="mobileMenu" class="hidden mt-4 space-y-2 pb-2">
        @if(auth()->user()->role == 'admin')
            ...
            <a href="{{ route('admin.notifications.index') }}"
                class="block px-4 py-3 rounded-lg text-white font-semibold transition-all duration-300 hover:bg-sky-700/50 {{ Request::is('admin/notifications/index*') ? 'bg-sky-800 border-l-4 border-sky-900' : '' }}">
                Notifikasi
            </a>
...
@else <strong>anda bukan admin</strong>
@endif