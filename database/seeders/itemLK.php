...
class itemLK extends Seeder
{
    ...
    public function run(): void
    {
         $barang_LK = [
            'LK' => [
                ['nama' => 'Pispot', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Bengkok', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Bak Instumen', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Pinset Cirugis', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Pinset Anatomis', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Gunting plester', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Gunting klem', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Gunting jaringan', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Pantom kelamin pria', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Pantom kelamin wanita', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Pantom RJP', 'stok' => 1, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Gunting Korentang', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Selimut', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Sprei', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Laken', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Stik Laken', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Perlak', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Bed', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Termometer', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ...
                ['nama' => 'WWZ', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ['nama' => 'Ice Bag', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
                ...
                ['nama' => 'Tounge Spatel', 'stok' => 2, 'jenis' => 'Kesehatan','status' => 'tersedia'],
             ...
             foreach($barang_LK as $LK =>$list){
                ...
                $encrypt = null;
                $origin = $this->findBestImagePath($LK, $namaAsli);
